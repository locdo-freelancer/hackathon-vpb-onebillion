      ...
      {isOpen && (
        <div className="absolute top-full right-0 mt-2 w-64 bg-slate-900 border border-slate-800 rounded-lg shadow-xl z-50 p-4">
          ...
          <div className="space-y-3">
            <div>
              <label className="text-xs text-gray-400 mb-1 block">{t("sites.status")}</label>
              <select
              ...
              >
                ...
                <option value="warning">{t("agents.warning")}</option>
              </select>
            </div>
            ...
            <div>
              ...
              >
                ...
                <option value="0">{t("sites.zeroAgents")}</option>
                <option value="1-5">{t("sites.oneToFiveAgents")}</option>
                <option value="5+">{t("sites.fivePlusAgents")}</option>
              </select>
            </div>
