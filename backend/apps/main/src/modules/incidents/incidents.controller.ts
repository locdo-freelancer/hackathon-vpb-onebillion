...
export class IncidentsController {
  ...
  async create(
    ...
    // Trigger AWS workflow for incident processing
    try {
      const workflowResult = await this.workflowService.processIncidentCreation(
        {
          incidentId: incident.id,
          siteId: createIncidentDto.site_id || "default",
          severity: createIncidentDto.severity,
          type: createIncidentDto.type,
          title: createIncidentDto.title,
          description: createIncidentDto.description || "",
          affectedSystems: createIncidentDto.affected_systems,
        }
      );
      ...
      console.error("Failed to initiate incident workflow:", workflowError);
      return incident;
    }
  }
